...
public class ScriptHelper {
    ...
    public static void startScript() {
        String script = String.format("export ENABLE_FLAC=%s&&export MIN_BR=%s&&export KUWO_COOKIE=\"%s\"&&export QQ_COOKIE=\"%s\"&&export MIGU_COOKIE=\"%s\"&&libnode.so app.js -a 127.0.0.1 -o %s -p %s",
                ...
                SettingHelper.getInstance().getKuwoCookie(),SettingHelper.getInstance().getQqCookie(),SettingHelper.getInstance().getMiguCookie(),SettingHelper.getInstance().getProxyOriginal(), SettingHelper.getInstance().getProxyPort() + ":" + (SettingHelper.getInstance().getProxyPort() + 1));
